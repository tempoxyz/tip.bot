/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 01999e4723bcc7cd9c1d80b467197f74)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		CHAT_STATE: DurableObjectNamespace<import("./entry-server").ChatStateDO>;
	}
	interface Env {
		DB: D1Database;
		CF_VERSION_METADATA: WorkerVersionMetadata;
