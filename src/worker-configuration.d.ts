/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 605aa61b3f8d7ac2455dfb3cc35a782d)
// Runtime types generated with workerd@1.20260511.1 2026-05-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./entry-server");
		durableNamespaces: "TipbotChatStateDO" | "NonceStorage";
	}
	interface PreviewEnv {
		DB: D1Database;
		PENDING_TIP_QUEUE: Queue;
		AI: Ai;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		HOST: "__PREVIEW_APEX__.tip.bot";
		SLACK_API_URL: "https://slack.com/api";
		TELEGRAM_API_URL: "https://api.telegram.org";
		TELEGRAM_BOT_USERNAME: "__PREVIEW_TELEGRAM_BOT_USERNAME__";
		TWITTER_API_URL: "https://api.twitter.com";
		TWITTER_BOT_HANDLE: "__PREVIEW_TWITTER_BOT_HANDLE__";
		FEE_PAYER_PRIVATE_KEY_MAINNET: string;
		FEE_PAYER_PRIVATE_KEY_TESTNET: string;
		SECRET_KEY: string;
		...
		CHAT_STATE: DurableObjectNamespace<import("./entry-server").TipbotChatStateDO>;
		AUTH_NONCE: DurableObjectNamespace<import("./entry-server").NonceStorage>;
	}
	interface ProductionEnv {
		...
		SLACK_API_URL: "https://slack.com/api";
		TELEGRAM_API_URL: "https://api.telegram.org";
		TELEGRAM_BOT_USERNAME: "ggtipbot";
		TWITTER_API_URL: "https://api.twitter.com";
	...
	interface Env {
		...
		AI: Ai;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		HOST: "__PREVIEW_APEX__.tip.bot" | "tip.bot" | "tipbot.localhost";
		SLACK_API_URL: "https://slack.com/api";
		TELEGRAM_API_URL: "https://api.telegram.org";
		TELEGRAM_BOT_USERNAME: "__PREVIEW_TELEGRAM_BOT_USERNAME__" | "ggtipbot";
		TWITTER_API_URL: "https://api.twitter.com";
		TWITTER_BOT_HANDLE: "__PREVIEW_TWITTER_BOT_HANDLE__" | "tipbotgg";
		FEE_PAYER_PRIVATE_KEY_MAINNET: string;
		FEE_PAYER_PRIVATE_KEY_TESTNET: string;
		SECRET_KEY: string;
		SLACK_CLIENT_ID: string;
		SLACK_CLIENT_SECRET: string;
		SLACK_SIGNING_SECRET: string;
		TELEGRAM_BOT_TOKEN: string | "000000:test";
		TELEGRAM_WEBHOOK_SECRET_TOKEN: string | "telegram-webhook-secret";
		TWITTER_OAUTH_CLIENT_ID: string;
		TWITTER_OAUTH_CLIENT_SECRET: string;
		CHAT_STATE: DurableObjectNamespace<import("./entry-server").TipbotChatStateDO>;
		AUTH_NONCE: DurableObjectNamespace<import("./entry-server").NonceStorage>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOST" | "SLACK_API_URL" | "TELEGRAM_API_URL" | "TELEGRAM_BOT_USERNAME" | "TWITTER_API_URL" | "TWITTER_BOT_HANDLE" | "FEE_PAYER_PRIVATE_KEY_MAINNET" | "FEE_PAYER_PRIVATE_KEY_TESTNET" | "SECRET_KEY" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_WEBHOOK_SECRET_TOKEN" | "TWITTER_OAUTH_CLIENT_ID" | "TWITTER_OAUTH_CLIENT_SECRET" | "TWITTER_ACCESS_TOKEN" | "TWITTER_ACCESS_TOKEN_SECRET" | "TWITTER_BEARER_TOKEN" | "TWITTER_CONSUMER_KEY" | "TWITTER_CONSUMER_SECRET">> {}
}
